...
$config['admin_page_menu']['main'] =
	array(
		'__config'					=> array('생망고관리', 'fa-gears'), // 1차 메뉴, 순서대로 (메뉴명, 아이콘클래스(font-awesome))
		'menu'						=> array(
			'gomain'				=> array('회원관리', ''), // 2차 메뉴, 순서대로 (메뉴명, a태그에 속성 부여)
			'layoutskin'			=> array('엑셀다운', ''),
